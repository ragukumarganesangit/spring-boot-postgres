...
public class MapExample {
    ...
    public static void main(String[] args) {
        ...
        map.putIfAbsent ( 0,"444" );    //already valiue ,so this wont effect
        map.putIfAbsent ( 10,"433344" );

        map.forEach((id, val) -> System.out.printf("%s : %s ", id , val));
        ...
        map.getOrDefault(42, "not found");  // not found . if no 42 key , then it return default value
